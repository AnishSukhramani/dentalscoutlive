...
export default function Home() {
  ...
  return (
    <div className="flex h-screen text-foreground" style={{backgroundImage: "url('/background-image.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundAttachment: "fixed"}}>
